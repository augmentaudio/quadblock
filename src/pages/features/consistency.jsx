        ...
        <div className="container text-left">
          ...
          <div>
            <header className="section-header text-left">
              <h2><Trans>Replace your Excel with quadblock</Trans></h2>
              <p>
                <Trans>
                  ...
                  quadblock will be your single source of truth.
            ...
            <div className="col-md-4 ml-auto">
              <p>
                <Trans>
                  ...
                  shares from one shareholder to another, quadblock will show you
            ...
            <div className="col-md-4 ml-auto">
              <p>
                <Trans>
                  ...
                  quadblock will track who owns which shares for each transaction
                  and assist you in entering valid share numbers.<br />
                  With quadblock you can be sure that no single share number goes
