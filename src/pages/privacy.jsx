    ...
    <main className="main-content">
      <div className="section">
        ...
        <Section>
          ...
          <PrivacyRow>
            ...
            <PrivacyElement
              ...
              body={i18n.t`If you add them with their email address and they decide to sign up on quadblock, shareholders can see their stake in your company and its latest valuation.`}
              size="6"
            />
          </PrivacyRow>
          <hr />
        ...
        <Section>
          <h2>The details</h2>
          <p>
            quadblock AG (“quadblock”, “we”) is a technology company that provides software as a
        ...
        <Section>
          ...
          <strong>When you decide to sign up on quadblock</strong>
          <p>
          ...
          <p>
            ...
            However, quadblock does not disclose Personal Data other than as described below.
          </p>
          ...
          <p>
            ...
            for marketing or advertising by Google. quadblock will not associate any data
        ...
        <Section>
          ...
          <p>
            ...
            to explicitly grant quadblock employees access to the company information.
        ...
        <Section>
          ...
          <p>
            quadblock discloses Personal Data only to those of its employees
            and third party contractors that (i) need to know that information
            in order to process it on quadblock’s behalf or to provide services
            available at quadblock’s websites (“Third Party Contractors”),
            and (ii) that have agreed not to disclose it to others by law.
          </p>
          <p>
            Other than to its employees and Third Party Contractors,
            as described above, quadblock discloses Personal Data only in
            response to a court order or other governmental request,
            or when quadblock believes in good faith that disclosure is reasonably
            necessary to protect the property or rights of quadblock or third parties.
          </p>

          <strong id="third-parties">Third Party Contractors used by quadblock</strong>
          <p>
          ...
          <ul>
            <li>
              ...
              We use MailChimp to send you updates from time to time, for which quadblock gives them
        ...
        <Section>
          ...
          <p>
            If quadblock, or substantially all of its assets, were acquired,
            or in the unlikely event that quadblock goes out of business or enters bankruptcy,
            ...
            of quadblock may continue to use your data as outlined in this Privacy Policy.
          </p>
        </Section>
        ...
        <Section>
          ...
          <p>
            Although most changes are likely to be minor, quadblock may change its
            Privacy Policy from time to time, and in quadblock’s sole discretion.
            quadblock will notify you of any changes to its Privacy Policy.
          </p>
        </Section>
        ...
        <Section>
          ...
          <p>
            ...
            Data Security Officer via <a href="mailto:contact@Quadblock.co">contact@Quadblock.co</a> or
